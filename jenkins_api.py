...
#a=list_jobs('http://34.238.125.123:8080', 'devops', 'devops')
#print(a)
...
#jenkins_csv_file(list_jobs('http://34.238.125.123:8080', 'devops', 'devops'))
jenkins_jobs = list_jobs('http://34.238.125.123:8080', 'devops', 'devops')
